"""
DeterministicSpanFinder — extract from chunklet-py.

Find a substring span within full text, ignoring non-alphanumeric characters.
A deterministic alternative to regex-based span finding, providing ~2x
performance improvement by avoiding backtracking and complex pattern matching.
"""
